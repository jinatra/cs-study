...
# [[80, 70], [70, 80], [30, 50], [90, 100], [100, 90],
#  [100, 100], [10, 30]]                                          [4, 4, 6, 2, 2, 1, 7]
#
# 입출력 예 설명
# 입출력 예 #1
...
def solution(score):
    avgs = []
    for s in score:
        avgs.append(sum(s)/len(s))
                                                # [75 70 55 65]
    sorted_avgs = sorted(avgs, reverse=True)    # [75 70 65 55]
    answer = []
    for avg in avgs:
        i = sorted_avgs.index(avg)
        answer.append(i+1)
    return answer
